...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Request.old_names'
        db.add_column(u'requests_request', 'old_names',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Request.old_names'
        db.delete_column(u'requests_request', 'old_names')
    ...
    models = {
        ...
        u'requests.request': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'names': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'name_requests'", 'symmetrical': 'False', 'to': u"orm['names.Name']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'requests_request', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_requests', to=orm['requests.Category'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account_requests', to=orm['account.Account'])),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('old_prayer_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'requests', ['Request'])

        # Adding M2M table for field names on 'Request'
        m2m_table_name = db.shorten_name(u'requests_request_names')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('request', models.ForeignKey(orm[u'requests.request'], null=False)),
            ('name', models.ForeignKey(orm[u'account.name'], null=False))
        ))
        db.create_unique(m2m_table_name, ['request_id', 'name_id'])

        # Adding model 'Category'
        db.create_table(u'requests_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'requests', ['Category'])

        # Adding model 'Pray'
        db.create_table(u'requests_pray', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'requests', ['Pray'])

        # Adding model 'PrayEvent'
        db.create_table(u'requests_prayevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_prayevents', to=orm['requests.Request'])),
            ('prayer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account_prayevents', to=orm['account.Account'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'requests', ['PrayEvent'])

        # Adding model 'Comment'
        db.create_table(u'requests_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_comments', to=orm['requests.Request'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account_comments', to=orm['account.Account'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('moderation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'requests', ['Comment'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field names on 'Request'
        db.delete_table(db.shorten_name(u'requests_request_names'))

        # Deleting model 'Category'
        db.delete_table(u'requests_category')

        # Deleting model 'Pray'
        db.delete_table(u'requests_pray')

        # Deleting model 'PrayEvent'
        db.delete_table(u'requests_prayevent')

        # Deleting model 'Comment'
        db.delete_table(u'requests_comment')
    ...
    models = {
        ...
        u'requests.request': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'names': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'name_requests'", 'symmetrical': 'False', 'to': u"orm['account.Name']"}),

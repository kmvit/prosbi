...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_account', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['names.Name']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Account.name'
        db.alter_column(u'account_account', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.Name']))

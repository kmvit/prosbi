...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.days_for_reminder'
        db.add_column(u'account_account', 'days_for_reminder',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.days_for_reminder'
        db.delete_column(u'account_account', 'days_for_reminder')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReminderItem.from_request'
        db.add_column(u'reminders_reminderitem', 'from_request',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ReminderItem.category'
        db.add_column(u'reminders_reminderitem', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['requests.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReminderItem.from_request'
        db.delete_column(u'reminders_reminderitem', 'from_request')

        # Deleting field 'ReminderItem.category'
        db.delete_column(u'reminders_reminderitem', 'category_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pray.slug'
        db.add_column(u'prays_pray', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pray.slug'
        db.delete_column(u'prays_pray', 'slug')
    ...
    models = {
        u'account.account': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'account'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },

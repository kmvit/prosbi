...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrayerBookItem'
        db.create_table(u'prays_prayerbookitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prayerbook', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prayerbook_items', to=orm['prays.PrayerBook'])),
            ('pray', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prays.Pray'])),
            ('index', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
        db.send_create_signal(u'prays', ['PrayerBookItem'])

        # Adding model 'PrayerBook'
        db.create_table(u'prays_prayerbook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.OneToOneField')(related_name='prayerbook', unique=True, to=orm['account.Account'])),
        ))
        db.send_create_signal(u'prays', ['PrayerBook'])


    def backwards(self, orm):
        # Deleting model 'PrayerBookItem'
        db.delete_table(u'prays_prayerbookitem')

        # Deleting model 'PrayerBook'
        db.delete_table(u'prays_prayerbook')
